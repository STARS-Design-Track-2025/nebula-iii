...
void main()
{
	...
	*/
	...
	reg_mprj_io_5 = GPIO_MODE_USER_STD_OUTPUT;	// MOSI
    reg_mprj_io_6 = GPIO_MODE_USER_STD_INPUT_NOPULL;	// MISO
	...
	// We don't need the Mgmt Core to initialize the SRAM for us lol
